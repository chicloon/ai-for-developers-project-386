...
ALTER TABLE visibility_groups ADD CONSTRAINT fk_visibility_groups_owner FOREIGN KEY (owner_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE group_members ADD CONSTRAINT fk_group_members_group FOREIGN KEY (group_id) REFERENCES visibility_groups(id) ON DELETE CASCADE;
ALTER TABLE group_members ADD CONSTRAINT fk_group_members_member FOREIGN KEY (member_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE group_members ADD CONSTRAINT fk_group_members_added_by FOREIGN KEY (added_by) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE schedules ADD CONSTRAINT fk_schedules_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE bookings ADD CONSTRAINT fk_bookings_schedule FOREIGN KEY (schedule_id) REFERENCES schedules(id) ON DELETE CASCADE;
ALTER TABLE bookings ADD CONSTRAINT fk_bookings_booker FOREIGN KEY (booker_id) REFERENCES users(id);
